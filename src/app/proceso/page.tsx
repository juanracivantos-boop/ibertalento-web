    ...
    <>
      ...
      <section className="py-16 md:py-20 bg-neutral-50">
        <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h2 className="mb-6 text-neutral-900">¿Por qué nuestro proceso funciona?</h2>
          </div>
          
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="bg-white rounded-xl p-8 shadow-lg border-2 border-neutral-200 hover:border-brand-red transition-all text-center">
              <div className="inline-flex h-14 w-14 items-center justify-center rounded-xl bg-brand-red mb-4 shadow-md">
                <CheckCircle2 className="h-7 w-7 text-white" aria-hidden="true" />
              </div>
              <h3 className="text-xl font-bold mb-3 text-neutral-900">Transparencia total</h3>
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg border-2 border-neutral-200 hover:border-brand-red transition-all text-center">
              ...
              <h3 className="text-xl font-bold mb-3 text-neutral-900">Evaluación rigurosa</h3>
              <p className="text-base text-neutral-700 leading-relaxed">
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg border-2 border-neutral-200 hover:border-brand-red transition-all text-center">
              ...
              <h3 className="text-xl font-bold mb-3 text-neutral-900">Acompañamiento continuo</h3>
              <p className="text-base text-neutral-700 leading-relaxed">
      ...
      <section className="py-20 bg-neutral-900 text-white">
        <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <Link href="/contacto" className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl font-bold text-white text-lg bg-brand-red hover:bg-brand-red-600 shadow-xl hover:shadow-2xl transition-all duration-200">
