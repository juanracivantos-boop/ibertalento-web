...
# Script para subir archivos directamente a public_html/ibertalento/
FTP_HOST="ftp.ibertalento.com"
FTP_USER="juanra@ibertalento.com"
FTP_PASS="t)6jqzhCIX5fsK;}"
LOCAL_DIR="./out"
REMOTE_DIR="/public_html/ibertalento/"

echo "🚀 Subiendo archivos directamente a public_html/ibertalento/..."
